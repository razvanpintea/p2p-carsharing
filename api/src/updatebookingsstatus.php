 ...
 * 
 * Update the status from "unseen" to "seen" of a specific booking, for notification purposes
 * 
 * @author Razvan Cristian Pintea w20018875
 */
class UpdateBookingsStatus extends Endpoint {
    ...
    protected function initialiseSQL() {
        ...
        $sql="UPDATE booking set status='seen' where ID=:ID";
        $this -> setSQL($sql);
