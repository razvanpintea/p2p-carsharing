 ...
 * Update Award
 * 
 * Endpoint for removing all the canceled bookings of the user based on the parameters received via POST
 * For notification purposes
 * 
 * 
 * @author Razvan Cristian Pintea w20018875
 */
class RemoveCanceledBookings extends Endpoint {
    ...
    protected function initialiseSQL() {
        ...
        $sql="DELETE FROM canceled_bookings where renter=:renter";
        $this -> setSQL($sql);
