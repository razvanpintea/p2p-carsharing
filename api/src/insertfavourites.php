 ...
 * Update Award
 * 
 * Endpoint for adding a new car to the favourites list based on the parameters received via POST
 * 
 * @author Razvan Cristian Pintea w20018875
 */
class InsertFavourites extends Endpoint {
    ...
    protected function initialiseSQL() {
        ...
        $sql="INSERT INTO favourites (renter, car) 
                      VALUES (:renter, :car)";
        $this -> setSQL($sql);
        $this -> setSQLParams(['renter'=> $_POST['renter'], 'car'=> $_POST['car']]);
    }
