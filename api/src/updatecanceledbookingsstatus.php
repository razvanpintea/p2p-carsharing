 ...
 * Update Award
 * 
 * Update the canceled_bookings database table based on parameters received through POST 
 * 
 * @author Razvan Cristian Pintea w20018875
 */
class UpdateCanceledBookingsStatus extends Endpoint {
    ...
    protected function initialiseSQL() {
        ...
        $sql="INSERT INTO canceled_bookings (renter, booking) VALUES(:renter, :booking)";
        $this -> setSQL($sql);
        $this -> setSQLParams(['renter'=> $_POST['renter'], 'booking'=> $_POST['booking']]);
    }
